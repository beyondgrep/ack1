...
sub search_resource {
    ...
    while ( ($text,$id) = $res->next_text() ) {
        ...
        if ( $has_lines
            ...
            if ( $keep_context ) {
                if ( $after ) {
                    print_match_or_context( $opt, 0, $lineno, $text );
                    $after--;
                }
        ...
        # XXX This only works on my own specific files.  It's not generic.
        ...
        print_match_or_context( $opt, 1, $id, $text );
